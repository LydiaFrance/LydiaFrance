...
<div class="d-flex justify-content-between mt-5">
    <a href="{{ '/projects/morphing-wings/page4/' | relative_url }}" class="btn" style="border-color: #6f42c1; color: #6f42c1;">
        ← Previous: Interactive Analysis
    </a>
    <a href="{{ '/projects/morphing-wings/index/' | relative_url }}" class="btn" style="background-color: #6f42c1; border-color: #6f42c1; color: white;">
        Back to Start →
    </a>
</div> 